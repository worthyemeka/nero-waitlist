        ...
        >
            <div className="mx-auto w-full max-w-[1264px]">
                ...
                <div className="mt-12 grid grid-cols-1 gap-6 xl:mt-14 xl:grid-cols-[730px_510px] xl:grid-rows-[480px_480px] xl:gap-6">
                    ...
                    >
                        {/* Text block */}
                        <div className="relative z-[6] max-w-[320px] pl-8 pt-10">
                            <h3 className="text-[22px] font-semibold leading-[1.12] tracking-[-0.03em] text-[#000000]">
                                Spend without running out
                            </h3>
                            <p className="mt-2 text-[17px] font-normal leading-[1.4] text-[#797C86]">
                                nēro shows how much you can spend today based on what you have left so your
                                money lasts the month.
                            </p>
                        </div>

                        {/* Phone mockup */}
                        <motion.div
                            style={{ y: phoneParallaxY, right: "-80px" }}
                        ...
                        {/* Soft bottom fade */}
                        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-[4] h-[170px] bg-gradient-to-t from-[#F2F3F2] via-[#F2F3F2]/90 to-transparent" />
                    </motion.article>
                    ...
                    <motion.article
                        ...
                        whileHover={{ y: -3 }}
                        className="relative h-[420px] overflow-hidden rounded-[24px] border border-black/10 bg-[linear-gradient(160deg,#EAF2FF_0%,#DBE9FF_72%,#D4E4FF_100%)] md:h-[480px] xl:col-[1/2] xl:row-[2/3] xl:w-[510px] xl:justify-self-start"
                    >
                    ...
                    <motion.article
                        ...
                        whileHover={{ y: -3 }}
                        className="relative h-[460px] overflow-hidden rounded-[24px] border border-black/10 bg-[linear-gradient(160deg,#FFFFFF_0%,#F2F2F2_74%)] md:h-[480px] xl:col-[2/3] xl:row-[2/3] xl:w-[730px] xl:justify-self-end"
                    >
                        <div className="absolute left-9 right-9 top-9">
