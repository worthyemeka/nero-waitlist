...
export default function PrivacyPolicy() {
    ...
    useEffect(() => {
        ...
        metaDesc.setAttribute('content', 'Read the Privacy Policy for nēro. Learn how we collect, use, and protect your personal information and data.');
    }, []);
    return (
        <div style={{ minHeight: "100vh", width: "100vw", fontFamily: "Satoshi, 'Helvetica Neue', Helvetica, Arial, sans-serif", background: "#fff", color: "#181818" }}>
            ...
            <div style={{ maxWidth: 700, margin: "0 auto", padding: "2.5rem 1.5rem" }}>
                ...
                <section><h2>3. Information We Collect</h2><h3>3.1 Information You Provide</h3><ul><li>Full name</li><li>Transaction email address</li><li>Phone number</li><li>Primary account details</li></ul><h3>3.2 Financial and Transaction Data</h3><p>With your explicit consent, we process:</p><ul><li>Bank alert messages (Email only)</li><li>Transaction data such as amount, date, and merchant (where available)</li></ul><p>nēro does not:</p><ul><li>Access your bank account directly</li><li>Store your banking login credentials</li></ul><h3>3.3 Device and Technical Data</h3><ul><li>IP address</li><li>Device type and operating system</li><li>App usage data</li><li>Log files and diagnostics</li></ul></section>
                ...
                <section><h2>12. Third-Party Services</h2><p>nēro may integrate with third-party services (e.g., email providers). Their use is governed by their respective privacy policies.</p></section>
