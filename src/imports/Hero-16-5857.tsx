import svgPaths from "./svg-yyyef861wl";
...
import { imgChangeColorHere, imgChangeColorHere2 } from "./svg-wy5sy";
...
function Vectors() {
  return (
    <div className="h-[1240.474px] relative w-[1616.918px]" data-name="vectors">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1616.92 1240.47">
        <g id="vectors">
          <g filter="url(#filter0_f_16_6092)" id="Ellipse 1987" opacity="0.45">
            ...
            <g clipPath="url(#paint0_angular_16_6092_clip_path)" mask="url(#path-1-inside-1_16_6092)" data-figma-skip-parse="true">
          ...
          <g filter="url(#filter1_f_16_6092)" id="Ellipse 1988" opacity="0.45">
            ...
            <g clipPath="url(#paint1_angular_16_6092_clip_path)" mask="url(#path-3-inside-2_16_6092)" data-figma-skip-parse="true">
          ...
          <g filter="url(#filter2_f_16_6092)" id="Ellipse 1989" opacity="0.45">
            ...
            <g clipPath="url(#paint2_angular_16_6092_clip_path)" mask="url(#path-5-inside-3_16_6092)" data-figma-skip-parse="true">
        ...
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="770.804" id="filter0_f_16_6092" width="785.446" x="336.44" y="210.595">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_16_6092" stdDeviation="5.18664" />
          </filter>
          <clipPath id="paint0_angular_16_6092_clip_path">
            <path d={svgPaths.p2e462f70} mask="url(#path-1-inside-1_16_6092)" />
          </clipPath>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="937.609" id="filter1_f_16_6092" width="1033.71" x="236.507" y="139.901">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_16_6092" stdDeviation="1.65178" />
          </filter>
          <clipPath id="paint1_angular_16_6092_clip_path">
            <path d={svgPaths.p16bd1000} mask="url(#path-3-inside-2_16_6092)" />
          </clipPath>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1066.75" id="filter2_f_16_6092" width="1379.08" x="175.629" y="111.884">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_16_6092" stdDeviation="1.65178" />
          </filter>
          <clipPath id="paint2_angular_16_6092_clip_path">
            <path d={svgPaths.p10901471} mask="url(#path-5-inside-3_16_6092)" />
          </clipPath>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="103.59" id="filter3_f_16_6092" width="98.0396" x="494.671" y="708.112">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_16_6092" stdDeviation="5.05318" />
          </filter>
        </defs>
      </svg>
    </div>
    ...
    <div className="h-[483.766px] relative w-[708.302px]">
      <div className="absolute inset-[-13.65%_-9.53%_-16.11%_-12.46%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 864.066 627.771">
          <g id="Group 54">
            <g filter="url(#filter0_f_16_6061)" id="Ellipse 13">
            ...
            <g filter="url(#filter1_f_16_6061)" id="Ellipse 14">
            ...
            <g filter="url(#filter2_f_16_6061)" id="Vector 11">
              <path d={svgPaths.p3ea56180} fill="var(--fill-0, #A5A5FF)" />
            </g>
            <g filter="url(#filter3_f_16_6061)" id="Vector 10">
              <path d={svgPaths.p30efb500} fill="var(--fill-0, #6C54FF)" />
            </g>
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="522.741" id="filter0_f_16_6061" width="555.962" x="308.104" y="-1.90735e-06">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_16_6061" stdDeviation="42.4428" />
            </filter>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="489.46" id="filter1_f_16_6061" width="597.895" x="3.8147e-06" y="138.311">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_16_6061" stdDeviation="59.4199" />
            </filter>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="408.471" id="filter2_f_16_6061" width="503.273" x="39.4697" y="168.381">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_16_6061" stdDeviation="45.2723" />
            </filter>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="359.278" id="filter3_f_16_6061" width="708.425" x="69.8043" y="106.147">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_16_6061" stdDeviation="45.2723" />
            </filter>
...
function Phones() {
  return (
    <div className="absolute h-[629px] left-[710px] overflow-clip top-[107px] w-[807.899px]" data-name="phones">
      <IPhone />
      <IPhone1 />
