import svgPaths from "./svg-io60lcb6l8";
...
import { imgChangeColorHere, imgChangeColorHere2 } from "./svg-np301";

function Background() {
  return (
    <div className="bg-[rgba(234,234,244,0.34)] relative rounded-[99px] shrink-0" data-name="Background">
    ...
    <div className="h-[1240.474px] relative w-[1616.918px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1616.92 1240.47">
        <g id="Frame 2147229665">
          <g filter="url(#filter0_f_10_6106)" id="Ellipse 1987" opacity="0.45">
            <mask fill="white" id="path-1-inside-1_10_6106">
              <path d={svgPaths.pecf8580} />
            </mask>
            <g clipPath="url(#paint0_angular_10_6106_clip_path)" mask="url(#path-1-inside-1_10_6106)" data-figma-skip-parse="true">
    ...
    <div className="h-[483.766px] relative w-[708.302px]">
      <div className="absolute inset-[-13.65%_-9.53%_-16.11%_-12.46%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 864.066 627.771">
          <g id="Group 54">
            <g filter="url(#filter0_f_10_6135)" id="Ellipse 13">
            ...
            <g filter="url(#filter1_f_10_6135)" id="Ellipse 14">
            ...
            <g filter="url(#filter2_f_10_6135)" id="Vector 11">
              <path d={svgPaths.p3ea56180} fill="var(--fill-0, #A5A5FF)" />
            </g>
            <g filter="url(#filter3_f_10_6135)" id="Vector 10">
              <path d={svgPaths.p30efb500} fill="var(--fill-0, #6C54FF)" />
            </g>
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="522.741" id="filter0_f_10_6135" width="555.962" x="308.104" y="-1.90735e-06">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_10_6135" stdDeviation="42.4428" />
            </filter>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="489.46" id="filter1_f_10_6135" width="597.895" x="3.8147e-06" y="138.311">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_10_6135" stdDeviation="59.4199" />
            </filter>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="408.471" id="filter2_f_10_6135" width="503.273" x="39.4697" y="168.381">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_10_6135" stdDeviation="45.2723" />
            </filter>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="359.278" id="filter3_f_10_6135" width="708.425" x="69.8043" y="106.147">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_10_6135" stdDeviation="45.2723" />
            </filter>
...
function HeroMockup() {
  return (
    <div className="absolute contents left-[349px] top-[-607px]" data-name="Hero mockup">
