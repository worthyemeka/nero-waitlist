...
import svgPaths from "./svg-gaucwp98g0";
...
import { imgChangeColorHere, imgChangeColorHere2 } from "./svg-bwoa6";

// Form state management (moved to top level for access)
let formEmail = "";
let formStatus: "idle" | "loading" | "success" | "error" = "idle";
let formMessage = "";
let updateForm: () => void = () => {};
...
function Background() {
  return (
    <motion.div
      ...
      className="bg-[rgba(234,234,244,0.34)] backdrop-blur-sm relative rounded-[99px] shrink-0"
    ...
    >
      <div className="content-stretch flex gap-[8px] items-center overflow-clip px-[12px] py-[6px] relative rounded-[inherit] size-full">
        <motion.div
          ...
          className="bg-[#2a2a91] rounded-[4px] shrink-0 size-[8px] relative"
          data-name="Background"
        >
          <motion.div
            animate={{ opacity: [1, 0.5, 1] }}
            transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
            className="absolute inset-0 bg-[#2a2a91] rounded-[4px]"
          />
        </motion.div>
...
function Frame51() {
  return (
    <div className="content-stretch flex flex-col h-[156px] items-center relative shrink-0 text-[64px] tracking-[-3px] w-full">
      <motion.div
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.2, duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
        className="flex flex-col font-['Satoshi:Bold',sans-serif] justify-center not-italic relative shrink-0 text-[#12123d] w-full"
      >
      ...
      <motion.div
        ...
        className="flex flex-col font-['Satoshi:Bold_Italic',sans-serif] italic justify-center relative shrink-0 text-[#2a2a91] w-full"
      >
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start leading-[0] relative shrink-0 w-full">
      ...
      <motion.div
        ...
        className="flex flex-col font-['Satoshi:Regular',sans-serif] justify-center not-italic relative shrink-0 text-[#696969] text-[22px] w-full"
      >
...
function Input({ value, onChange, disabled }: { value: string; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void; disabled: boolean }) {
  return (
    <motion.div
      ...
      className="bg-[#f7f7f7] content-stretch flex flex-col h-[48px] items-start min-w-[304px] overflow-clip pl-[18px] pr-[16px] py-[14px] relative rounded-[80px] shrink-0 w-[459px]"
      data-name="Input"
    >
      <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
        <input
          ...
          disabled={disabled}
          className="w-full bg-transparent border-none outline-none font-['Satoshi:Regular',sans-serif] leading-[0] text-[16px] text-black placeholder:text-[rgba(0,0,0,0.4)] disabled:opacity-50 disabled:cursor-not-allowed leading-[normal] focus:outline-none"
        />
      </div>
    </motion.div>
  );
...
function Background1({ disabled, loading }: { disabled: boolean; loading: boolean }) {
  return (
    <motion.button
      type="submit"
      disabled={disabled}
      ...
      className="bg-[#2a2a91] relative rounded-[80px] self-stretch shrink-0 hover:bg-[#1f1f6f] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      data-name="Background"
    >
        ...
        <div className="content-stretch flex items-center px-[20px] py-[16px] relative size-full">
          <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
            <div className="flex flex-col font-['Satoshi:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">
              <p className="leading-[16px]">{loading ? "Joining..." : "Join the waitlist"}</p>
            </div>
          </div>
        </div>
      </div>
...
function FormMcEmbeddedSubscribeForm() {
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Form - mc-embedded-subscribe-form">
      <form onSubmit={handleSubmit} className="content-stretch flex gap-[12px] items-start pr-[12px] relative size-full">
        <Input value={email} onChange={(e) => setEmail(e.target.value)} disabled={status === "loading" || status === "success"} />
        <Background1 disabled={status === "loading" || status === "success"} loading={status === "loading"} />
      </form>
      <AnimatePresence mode="wait">
        {message && (
          <motion.div
            ...
            className={`mt-3 text-sm font-['Satoshi:Medium',sans-serif] flex items-center gap-2 ${status === "success" ? "text-green-700" : "text-red-700"}`}
          >
            <motion.span
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
...
function Image() {
  return (
    <motion.div
      ...
      className="absolute aspect-[32/32] bottom-0 left-0 rounded-[32px] top-0"
      data-name="Image"
    >
      <Image1 />
...
function Image2() {
  return (
    <motion.div
      ...
      className="absolute aspect-[32/32] bottom-0 left-[16px] rounded-[32px] top-0"
      data-name="Image"
    >
      <Image3 />
      <div className="absolute border border-solid border-white left-0 rounded-[32px] size-[32px] top-0" data-name="Border" />
...
function Image4() {
  return (
    <motion.div
      ...
      className="absolute aspect-[32/32] bottom-0 left-[32px] rounded-[32px] top-0"
      data-name="Image"
    >
      <Image5 />
      <div className="absolute border border-solid border-white left-0 rounded-[32px] size-[32px] top-0" data-name="Border" />
...
function Image6() {
  return (
    <motion.div
      ...
      className="absolute aspect-[32/32] bottom-0 right-0 rounded-[32px] top-0"
      data-name="Image"
    >
      <Image7 />
      <div className="absolute border border-solid border-white left-0 rounded-[32px] size-[32px] top-0" data-name="Border" />
...
function Frame57() {
  ...
  return (
    ...
    >
      <ImageBlock />
      <div className="flex flex-col font-['Instrument_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#2a2a91] text-[16px] tracking-[-0.32px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame55() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[78px] top-[133px] w-[660px]">
      <Background />
      <Frame54 />
    </div>
  );
    ...
    <div className="h-[1240.474px] relative w-[1616.918px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1616.92 1240.47">
        <g id="Frame 2147229665">
          <g filter="url(#filter0_f_13_6141)" id="Ellipse 1987" opacity="0.45">
            <mask fill="white" id="path-1-inside-1_13_6141">
              <path d={svgPaths.pecf8580} />
            </mask>
            <g clipPath="url(#paint0_angular_13_6141_clip_path)" mask="url(#path-1-inside-1_13_6141)" data-figma-skip-parse="true">
...
function IPhone() {
  return (
    <motion.div
      ...
      className="-translate-x-1/2 absolute contents left-[calc(50%+117.59px)] top-[-27.28px]"
      data-name="iPhone"
    >
      <motion.div
        animate={{ y: [0, -8, 0] }}
...
function IPhone1() {
  return (
    <motion.div
      ...
      whileHover={{ y: -5, transition: { duration: 0.3 } }}
      className="-translate-x-1/2 absolute contents left-[calc(50%-119.6px)] top-[42.43px]"
      data-name="iPhone"
    >
      <motion.div
        animate={{ y: [0, -12, 0] }}
    ...
    <div className="h-[483.766px] relative w-[708.302px]">
      <div className="absolute inset-[-13.65%_-9.53%_-16.11%_-12.46%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 864.066 627.771">
          <g id="Group 54">
            <g filter="url(#filter0_f_13_6125)" id="Ellipse 13">
            ...
            <g filter="url(#filter1_f_13_6125)" id="Ellipse 14">
            ...
            <g filter="url(#filter2_f_13_6125)" id="Vector 11">
              <path d={svgPaths.p3ea56180} fill="var(--fill-0, #A5A5FF)" />
            </g>
            <g filter="url(#filter3_f_13_6125)" id="Vector 10">
              <path d={svgPaths.p30efb500} fill="var(--fill-0, #6C54FF)" />
            </g>
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="522.741" id="filter0_f_13_6125" width="555.962" x="308.104" y="-1.90735e-06">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_13_6125" stdDeviation="42.4428" />
            </filter>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="489.46" id="filter1_f_13_6125" width="597.895" x="3.8147e-06" y="138.311">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_13_6125" stdDeviation="59.4199" />
            </filter>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="408.471" id="filter2_f_13_6125" width="503.273" x="39.4697" y="168.381">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_13_6125" stdDeviation="45.2723" />
            </filter>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="359.278" id="filter3_f_13_6125" width="708.425" x="69.8043" y="106.147">
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
              <feGaussianBlur result="effect1_foregroundBlur_13_6125" stdDeviation="45.2723" />
            </filter>
...
function HeroMockup() {
  return (
    <motion.div
      ...
      className="absolute contents left-[349px] top-[-607px]"
      data-name="Hero mockup"
    >
      <div className="absolute flex h-[1974.094px] items-center justify-center left-[349px] top-[-607px] w-[2037.817px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <motion.div
          ...
          className="flex-none rotate-[38.13deg]"
        >
          <Frame50 />
        </motion.div>
      </div>
...
function Logo() {
  return (
    <motion.div
      ...
      animate={{ opacity: 1, x: 0 }}
      transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
      className="h-[20.009px] relative shrink-0 w-[67.344px]"
      data-name="logo"
    >
...
function Content() {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.95 }}
      className="bg-[#2a2a91] content-stretch flex gap-[12px] h-[40px] items-center justify-center overflow-clip px-[22px] py-[16px] relative rounded-[107px] shrink-0 hover:bg-[#1f1f6f] transition-colors cursor-pointer"
      data-name="Content"
    >
      <Title1 />
      <IconFlipArrow />
...
function Frame56() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-center left-0 px-[80px] py-[20px] top-0 w-[1440px]">
      <Navigation />
    </div>
  );
}
...
function Section() {
  ...
  const gradientY = useTransform(scrollY, [0, 300], [0, -50]);
  const gradientOpacity = useTransform(scrollY, [0, 300], [1, 0.7]);

  return (
    <div className="relative bg-white h-auto min-h-[952px] left-0 overflow-hidden top-0 w-[1440px] pb-[200px]" data-name="Section">
      {/* Background Gradient */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        className="absolute flex h-[1690.031px] items-center justify-center left-[697px] top-[-172px] w-[1528.685px]"
        data-name="BackgroundGradient"
      >
        <motion.div
          animate={{ rotate: [-25.27, -23, -25.27] }}
          transition={{ duration: 20, repeat: Infinity, ease: "easeInOut" }}
          className="-scale-y-100 flex-none"
          style={{ rotate: -25.27 }}
        >
          <div className="h-[1377.936px] relative w-[1040.044px]">
...
export default function Hero() {
  return (
    <div className="relative w-full min-h-screen flex items-start md:items-center justify-center bg-white overflow-hidden" data-name="Hero">
      <div className="relative w-full max-w-[1440px] mx-auto">
        {/* Scale container for mobile/tablet */}
        <div className="origin-top-left transform scale-[0.45] sm:scale-[0.6] md:scale-[0.75] lg:scale-100">
          <Section />
          <div className="absolute flex h-[146px] items-center justify-center left-[2px] top-[629px] w-[1436px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
            <div className="-rotate-90 flex-none">
              <div className="bg-gradient-to-l from-[rgba(255,255,255,0)] h-[1436px] to-[74.257%] to-white w-[146px]" />
            </div>
          </div>
        </div>
      </div>
