...
const FROM_EMAIL =
  process.env.FROM_EMAIL ?? "nēro <hello@neroapp.co>";

const REPLY_TO_EMAIL =
  process.env.REPLY_TO_EMAIL ?? "hello@neroapp.co";

const UNSUBSCRIBE_EMAIL =
  process.env.UNSUBSCRIBE_EMAIL ?? "unsubscribe@neroapp.co";
...
function buildWelcomeTextEmail(): string {
  return `
You're officially on the nēro waitlist.

We're excited to have you here.

We're building nēro to help you know what you can safely spend every day.
...
Watch nēro come to life, get sneak peeks, and occasional money reality checks.
https://www.instagram.com/getneroapp/

3. Follow us on LinkedIn
Follow along as we build and share what it takes to create nēro from the ground up.
...
<body style="margin:0;padding:0;background-color:#FFFFFF;">
    <div class="preheader-ghost" aria-hidden="true"
        ...
        You're officially on the nēro waitlist. Get early updates, join our WhatsApp community, and follow us on our socials.
    </div>
                ...
                <table role="presentation" class="email-wrapper" cellpadding="0" cellspacing="0" border="0" width="600"
                        ...
                        <td class="topbar-cell" style="text-align:center;padding:10px 20px;background-color:#FFFFFF;">
                            <p class="topbar-text"
                                ...
                                <a href="${BROWSER_VIEW_URL}" class="topbar-link"
                                    style="color:#2A2A91;text-decoration:underline !important;">View it in your browser</a>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="hero-cell"
                            ...
                            style="background-color:#2A2A91;background-image:url('https://res.cloudinary.com/dentghiic/image/upload/v1780264016/Cards_bg_szjabs.png');background-size:cover;background-position:center top;background-repeat:no-repeat;padding:0;font-size:0;line-height:0;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" class="feature-pad" style="padding:0 40px;">
                                        ...
                                        <a href="https://chat.whatsapp.com/GmIOkXzIITu8knz6QHo45m?mode=gi_t"
                                            ...
                                            <img src="https://res.cloudinary.com/dentghiic/image/upload/v1780271570/feature_1_iakvb7.png"
                                                alt="Join our WhatsApp community for early updates, testing invites, and first dibs on what is coming next."
                                                width="520"
                                        ...
                                        <a href="https://www.instagram.com/getneroapp/" target="_blank"
                                            ...
                                            <img src="https://res.cloudinary.com/dentghiic/image/upload/v1780271571/feature_2_znjkfd.png"
                                                alt="Follow us on Instagram to watch nēro come to life, see sneak peeks, and get money reality checks."
                                                width="520"
                                                style="display:block;width:100%;max-width:520px;height:auto;margin:0 0 28px 0;border:0;" />
                                        </a>
                                        ...
                                        <a href="https://www.linkedin.com/company/neroapp-ltd/" target="_blank"
                                            ...
                                            <img src="https://res.cloudinary.com/dentghiic/image/upload/v1780271570/feature_3_pyd0ju.png"
                                                alt="Follow us on LinkedIn to see the bigger picture as we build nēro from the ground up."
                                                width="520"
                    ...
                    <tr>
                        <td class="hero-cell" style="background-color:#2A2A91;font-size:0;line-height:0;">
                            <img src="https://res.cloudinary.com/dentghiic/image/upload/v1780271571/close_brcfhf.png"
                                alt="We will be in touch soon. Thanks for being one of the early believers." width="600"
                                style="display:block;width:100%;max-width:600px;height:auto;border:0;" />
                        </td>
                    </tr>
