            ...
            <tr>
              <td class="topbar-cell" style="text-align:center;padding:10px 20px;background-color:#F8F7F7;">
                ...
                >
                  ...
                  <a
                    href="https://waitlist.neroapp.co/browser-view"
                    class="topbar-link"
                ...
                >
                  <tr>
                    ...
                    >
                      <p
                        class="signoff-text"
                        style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:300;font-size:22px;color:#0a0a0a;letter-spacing:0.2px;line-height:1.5;margin:0;"
                      >
                        Thanks again for joining us early.
                      </p>
                      <p
                        class="signoff-text"
                        style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:300;font-size:22px;color:#0a0a0a;letter-spacing:0.2px;line-height:1.5;margin:22px 0 0;"
                      >
                        See you soon.
                      </p>
                      <p
